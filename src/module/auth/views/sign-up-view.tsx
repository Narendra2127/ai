            ...
            <CardContent className="grid p-0 md:grid-cols-2"> 
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                   <div className="flex flex-col gap-6">
                    ...
                    <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2:z-0 after:flex after:items-center after:border-t">
